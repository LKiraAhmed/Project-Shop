...
<head>
    ...
    <title>Registration :: Be Unique – Minimal Fashion Bootstrap 5 Template</title>
                                    ...
                                    <div class="mini-cart-dropdown">
                                        <div class="cart-item">
                                            ...
                                            <div class="content">
                                                ...
                                                <a class="cart-trash" href="javascript:void(0);"><i
        ...
        <footer class="footer-area">
                            ...
                            <div class="widget-item">
                                <div class="about-widget">
                                    <div class="footer-logo-area">
                                        <a href="index">
                                            <img class="logo-main footer-logo" src="assets/img/be-unique-logo.jpg"
                                                alt="Logo" />
                                        </a>
                                    </div>
                                    ...
                                    <ul>
                                        <li><i class="ion-ios7-location-outline"></i> 184 Be Unique Rd E, St Be Unique
                                            VIC 3021,</li>
                                        <li><i class="ion-ios7-email-outline"></i> <a
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <p class="copyright">© 2023 <span>Be Unique</span>. Made with <i
                                    class="fa fa-heart icon-heart"></i> by <a target="_blank"
                                    href="crevel-eg.com"> Crevel</a></p>
                        </div>
                    </div>
                </div>
            </div>
