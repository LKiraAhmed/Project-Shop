                            ...
                            <div class="main-content-wrap">
                                ...
                                <div class="wg-box">
                                    <div class="flex items-center justify-between gap10 flex-wrap">
                                        ...
                                        <a class="tf-button style-1 w208" href="new-category.html"><i
                                                class="icon-plus"></i>Add new</a>
                                    </div>
                                    @foreach($categories as $categories)
                                    <div class="wg-table table-all-category" style="overflow: hidden !important;">
                                        ...
                                        <ul class="flex flex-column">
                                            <li class="product-item col-4 col-md-9 ">
                                                <div class="flex items-center  justify-between   flex-grow">
                                                    <div class="name">
                                                        <a href="product-list" class="body-title-2">{{$categories->name}}</a>
                                                    </div>
