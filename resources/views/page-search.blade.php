...
<head>
    ...
    <title>Page Search :: Be Unique – Minimal Fashion Bootstrap 5 Template</title>
                      ...
                      <div class="col-md-4">
                          <div class="product-item">
                            <a href="{{ route('products.single', $product->id) }}">
                              <img class="w-80" src="{{ Storage::url($product->image) }}" alt="{{ $product->name }}">
                          </a>
                          <h4>{{ $product->name }}</h4>
                              <?php
          ...
          <div class="col-sm-6 col-lg-3">
            ...
            <div class="widget-item">
              <div class="about-widget">
                ...
                <ul>
                  <li><i class="ion-ios7-location-outline"></i> Be Unique Rd E, St Be Unique VIC 3021,</li>
